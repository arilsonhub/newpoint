<?php
    ...
    *
    */
   class QuerosabermaisController extends ControllerBase{
		...
		*/
		public function QuerosabermaisController($controller,$action,$urlparams){
	   ...
	   private function cadastrar(){ 		   		
	        ...
	        if($_SERVER['REQUEST_METHOD'] == "POST"){
			     ...
			     $this->Delegator('QuerosabermaisDAO', 'cadastrar', $this->getPost());
