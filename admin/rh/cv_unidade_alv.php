<?php
	...
	$query = "SELECT *, to_char(data_envio, 'dd/mm/YYYY') AS data FROM trabalheconosco WHERE idunidade = 1 ORDER BY idunidade ASC";
...
<body>
  ...
  <div role="main" id="main">
  	...
  	<div id="abas">
  		...
  		<table>
  			<thead>
  				<th><a href="cv_unidade_alv.php">Alvorada</a></th>
  				<th><a href="cv_unidade_gti.php">Gravataí</a></th>
  				<th><a href="cv_unidade_poa.php">Porto Alegre</a></th>
  				<th><a href="cv_unidade_via.php">Viamão</a></th>
  			</thead>
  		</table>
  	</div>
  	<div id="">
