				...
				<tbody>
					<?php
						while($row = pg_fetch_assoc($result)){
							...
							echo "<td class='acao'><a href='editar_noticia.php?id=$id' title='editar'><img src='../img/edi.png' alt='editar' /></a> | <a href='excluir.php?a=1&id=$id&img=../../web_files/upload/noticias/$img' title='deletar'><img src='../img/del.png' alt='editar' /></a></td>\n";
							echo "</tr>\n";
						}
					?>
				</tbody>
