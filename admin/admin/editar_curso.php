  ...
  <div role="main" id="main">
  	...
  	<div id="div_cursos">
  		<form action="recebe.php" method="post">
  			<fieldset>
  				<label for="nome">Nome:</label><input type="text" name="nome" id="nome" value="<?php echo $row['nome']; ?>"/><br />
  				<input type="hidden" name="a" value="14" /><input type="hidden" name="id" value="<?php echo $row['id']; ?>" /><button>Enviar.</button>
  			</fieldset>
  		</form>
  	</div>
