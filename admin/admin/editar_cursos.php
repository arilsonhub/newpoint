				...
				<tbody>
					<?php
						while($row = pg_fetch_assoc($result)){
							...
							echo "<tr>\n";
							echo "<td>$nome</td>";
							echo "<td class='acao'><a href='editar_curso.php?id=$id' title='editar'><img src='../img/edi.png' alt='editar' /></a> | <a href='excluir.php?a=5&id=$id' title='deletar'><img src='../img/del.png' alt='editar' /></a></td>\n";
							echo "</tr>\n";
						}
					?>
				</tbody>
