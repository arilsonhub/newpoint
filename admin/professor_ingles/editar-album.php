        ...
        <?php
          ...
          while($row  = pg_fetch_assoc($result)){
            ...
            if($maximoDeFotos != null && $recordsetFotoAlbum['total_fotos'] > $maximoDeFotos){            	
				...
				?>
				<form id="album_deletar_form" method="post" action="recebe.php">
	            	<td>
	            		...
	            		<a href='#' title='excluír Álbum' onclick="if(confirm('deseja excluir?')){ document.getElementById('album_deletar_form').submit();  }"><img src='../img/del.png' /></a>	            	
	            	</td>
	            </form>
            	<?php 
            }
