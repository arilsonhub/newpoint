  			...
  			<tbody>
  				<?php
  					...
  					while($row = pg_fetch_assoc($result)){
  						...
  						echo "<td>".$resposta."</td>";
  						echo "<td class='acao'><a href='excluir.php?a=2&id=$id' title='deletar'><img src='../img/del.png' alt='editar' /></a></td>\n";
  						echo "</tr>\n";
  					}
  		...
  		<div id="formulario_convenios" class="">
	  		<form action="recebe.php" method="post" enctype="multipart/form-data">
	  			...
	  			<fieldset>
	  				...
	  				<label for="desconto">Desconto:</label><input type="text" name="desconto" id="desconto" maxlength="4"/><br />
