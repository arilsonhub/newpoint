<?php
  ...
  include "../php/restrito.php";
	...
	$query			= "select * from agenda order by id DESC LIMIT 10";
  			...
  			<tbody>
  				<?php
  					...
  					while($row = pg_fetch_assoc($result)){
						...
						echo "<td>".$row['onde']."</td>";
						echo "<td class='acao'><a href='editar_agenda.php?id=$id' title='editar'><img src='../img/edi.png' alt='editar' /></a> | <a href='excluir.php?a=4&id=$id' title='deletar'><img src='../img/del.png' alt='editar' /></a></td>\n";
						echo "</tr>\n";
  					}
